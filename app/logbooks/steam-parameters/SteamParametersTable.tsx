...
export default function SteamParametersTable({ steamParameters, loading }: SteamParametersTableProps) {
  // Local state to manage steam parameters
  const [data, setData] = useState<SteamParameters[]>(steamParameters);

  // Update local data when steamParameters prop changes
  useEffect(() => {
  ...
  const columns = useMemo<ColumnDef<SteamParameters>[]>(
    () => [
      {
        id: 'rowIndex',
        header: 'No.',
      ...
      },
      {
        ...
        header: 'Stack Temperature',
      },
      {
        accessorKey: 'feedWaterTemperature',
        header: 'Feed Water Temperature',
      },
      {
        accessorKey: 'feedWaterMeterReading',
        header: 'Feed Water Meter Reading',
      },
      {
      ...
      },
      {
        ...
        header: 'Feed Water Pr',
      },
      {
        accessorKey: 'feedWaterPh',
        header: 'Feed Water pH',
      },
      {
        accessorKey: 'feedWaterTds',
        header: 'Feed Water TDS',
      },
      {
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            {table.getRowModel().rows.length === 0 && !loading && (
              <tr>
                ...
                >
                  No steam parameters records found.
                </td>
              </tr>
            )}
            {loading && (
